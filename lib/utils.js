  ...
  const response = await client.chat(
    {
      ...
      preamble: "You are an assistant to a fact checker. Given a document, question, or statement, identify any claim(s) made which need to be fact checked or simply require further research and return them in descending order of relevance / fact checking priority. Return JSON"
    }
  )
